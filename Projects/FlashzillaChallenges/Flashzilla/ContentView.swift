...
struct ContentView: View {
    ...
    @State private var editScreenShown = false
    ...
    var body: some View {
        ...
        .sheet(isPresented: $editScreenShown, onDismiss: resetCards, content: EditCards.init)
